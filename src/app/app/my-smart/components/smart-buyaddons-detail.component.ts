...
@Component({
    selector: 'smart-buyaddons-detail',
    templateUrl: './app/my-smart/components/smart-buyaddons-detail.component.html',
    directives: [
        SmartLeftMenuComponent
    ]
})
export class SmartBuyAddOnsDetailComponent {
    ...
    constructor(private _router: Router,
        ...
        this._layoutService.setCurrentPage('BuyAddOnsDetail');
